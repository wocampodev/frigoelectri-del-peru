...
@section('content')
    ...
    <div class="container mb-5">
        <div class="row d-flex no-gutters align-items-stretch mt-3">
            <div class="col-12 col-lg-6 block__73422 order-lg-2 aos-init aos-animate" style="background-image: url('assets/images/gallery-1.jpg');" data-aos="fade-left" data-aos-delay=""></div>
        ...
        <div class="row d-flex no-gutters align-items-stretch mt-3">
            ...
            <div class="col-12 col-lg-6 block__73422 order-lg-2 aos-init aos-animate" style="background-image: url('assets/images/gallery-1.jpg');" data-aos="fade-right" data-aos-delay=""></div>
        </div>
    </div>
