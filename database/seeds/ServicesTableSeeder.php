...
class ServicesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('services')->insert(['name' => 'Tableros eléctricos y de transferencia', 'tableros-electricos-y-de-transferencia' => '', 'short_description' => 'Elaboración de tableros eléctricos y de transferencia']);
