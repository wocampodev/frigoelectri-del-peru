...
class ServicesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('services')->insert(['name' => 'Aire acondicionado', 'slug' => 'aire-acondicionado', 'short_description' => 'Aire acondicionado industrial y residencial', 'image' => 'mantenimieno-aire-acondicionado.jpeg']);
        DB::table('services')->insert(['name' => 'Aire acondicionado automotriz', 'slug' => 'aire-acondicionado-automotriz', 'short_description' => 'Aire acondicionado automotriz', 'image' => 'aire-acondicionado-automotriz.jpeg']);
        DB::table('services')->insert(['name' => 'Reparaciones y mantenimiento', 'slug' => 'reparaciones-y-mantenimiento', 'short_description' => 'Reparación, mantenimiento y proyecto de subestaciones eléctricas. Reparación de máquinas de calor', 'image' => 'reparacion-aire.jgeg']);
        ...
        DB::table('services')->insert(['name' => 'Tableros eléctricos y de transferencia', 'slug' => 'tableros-electricos-y-de-transferencia', 'short_description' => 'Elaboración de tableros eléctricos y de transferencia', 'image' => 'tablero-transferencia.jpg']);
