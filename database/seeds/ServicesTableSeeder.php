...
class ServicesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('services')->insert(['name' => 'Aire acondicionado', 'slug' => 'aire-acondicionado', 'short_description' => 'Aire acondicionado industrial y residencial', 'image' => 'mantenimieno-aire-acondicionado.jpg']);
        ...
        DB::table('services')->insert(['name' => 'Fabricación de tableros', 'slug' => 'fabricacion-de-tableros', 'short_description' => 'Elaboración de tableros eléctricos y de transferencia', 'image' => 'fabricacion-tablero.jpeg']);
