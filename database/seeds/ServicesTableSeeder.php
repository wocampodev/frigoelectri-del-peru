...
class ServicesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('services')->insert(['name' => 'Instalaciones de Gases', 'slug' => 'instalaciones-de-gases', 'short_description' => 'Nuestro servicio de instalación de gases cumple con los protocolos de seguridad de acuerdo a la necesidad de tu organización.', 'image' => 'instalacion-gas-medicinal.jpeg']);
        DB::table('services')->insert(['name' => 'Aire Acondicionado', 'slug' => 'aire-acondicionado', 'short_description' => 'Instalación, limpieza y mantenimiento de aire acondicionado.', 'image' => 'mantenimiento-aire-acondicionado.jpg']);
        ...
        DB::table('services')->insert(['name' => 'Aire Acondicionado Automotriz', 'slug' => 'aire-acondicionado-automotriz', 'short_description' => 'Reparación y mantenimiento de aire acondicionado automotriz.', 'image' => 'aire-acondicionado-automotriz.jpeg']);
        ...
        DB::table('services')->insert(['name' => 'Electicidad de Baja tensión', 'slug' => 'electricidad-baja-tension', 'short_description' => 'Proyectos eléctricos, climatización extracción y obras eléctricas.', 'image' => 'proyecto-baja-media-tension.jpg']);
        DB::table('services')->insert(['name' => 'Electicidad de Media tensión', 'slug' => 'electricidad-media-tension', 'short_description' => 'Reparación, mantenimiento y proyectos de subestaciones eléctricas.', 'image' => 'proyecto-media-tension.jpg']);
